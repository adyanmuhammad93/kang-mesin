    ...
    <>
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-24 md:py-36">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl md:text-6xl font-extrabold leading-tight mb-6 tracking-tight">
              ...
              <span className="block text-accent-500">Built to Perform.</span>
            </h1>
            <p className="text-industrial-300 text-lg md:text-xl leading-relaxed mb-10 max-w-2xl">
              Industrial-grade conveyor systems, hydraulic equipment, CNC machinery, and compressors — engineered for the most demanding production environments.
            </p>
            <div className="flex flex-wrap gap-4">
              ...
              <a
                href="https://wa.me/6281234567890?text=Halo,%20saya%20ingin%20mengetahui%20lebih%20lanjut%20tentang%20produk%20mesin%20industri%20Anda"
                target="_blank"
          ...
          <div className="max-w-7xl mx-auto px-6 py-8">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              {[
                ...
                { value: '1,200+', label: 'Units Delivered' },
      ...
      <section id="products" className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6">
          <div className="mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-industrial-900 mb-3">Product Catalog</h2>
            <p className="text-industrial-500 text-lg max-w-2xl">
              Browse our comprehensive lineup of industrial machinery, engineered for performance and built to last.
            </p>
          </div>
          ...
          {products.length === 0 ? (
            <div className="text-center py-20 text-industrial-400">
              ...
              <p className="text-sm mt-1">Add products via the CMS at /admin</p>
            </div>
          ) : (
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
              {products.map((product) => (
                ...
                >
                  ...
                  <div className="p-4">
                    <p className="text-xs text-industrial-400 font-mono mb-1.5">SKU: {product.sku}</p>
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-industrial-900 mb-6">
                Why Leading Industries Choose TeknoMesin
              </h2>
                ...
                {[
                  {
                    ...
                    desc: 'Every machine is manufactured under strict ISO 9001:2015 quality management processes.',
                  },
                  {
                    icon: '🔧',
                    title: 'Expert After-Sales Support',
                    desc: 'Dedicated engineers provide installation, commissioning, and ongoing maintenance.',
                  },
                  {
                    icon: '🚚',
                    title: 'Fast Nationwide Delivery',
                    desc: 'Strategic warehousing ensures on-time delivery to any location across Indonesia.',
                  },
                  {
                    icon: '📋',
                    title: 'Custom Engineering',
                    desc: 'We design and manufacture machinery tailored to your exact process requirements.',
                  },
                ].map((item) => (
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-industrial-950 rounded-2xl p-6 text-white">
                <div className="text-4xl font-extrabold text-accent-500 mb-2">15+</div>
                <div className="text-industrial-300 text-sm">Years of industrial expertise</div>
              </div>
              <div className="bg-accent-500 rounded-2xl p-6 text-white mt-8">
                <div className="text-4xl font-extrabold mb-2">500+</div>
                <div className="text-orange-100 text-sm">Satisfied industrial clients</div>
              </div>
              <div className="bg-industrial-100 rounded-2xl p-6 text-industrial-900 mt-[-16px]">
                ...
                <div className="text-industrial-500 text-sm">Machines delivered & running</div>
              </div>
              <div className="bg-industrial-800 rounded-2xl p-6 text-white">
                <div className="text-4xl font-extrabold text-white mb-2">24/7</div>
                <div className="text-industrial-300 text-sm">Technical support availability</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="contact" className="py-20 bg-industrial-950 text-white">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <p className="text-industrial-300 text-lg mb-10 max-w-xl mx-auto">
            Our engineering team is ready to help you select the right machinery for your production needs.
          </p>
          <a
            href="https://wa.me/6281234567890?text=Halo,%20saya%20ingin%20konsultasi%20mengenai%20kebutuhan%20mesin%20industri"
            target="_blank"
            rel="noopener noreferrer"
      ...
      <footer className="bg-industrial-950 border-t border-industrial-800 py-8">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-4 text-industrial-500 text-sm">
          ...
          <div className="flex gap-6">
            <Link href="/admin" className="hover:text-white transition-colors">CMS Admin</Link>
          </div>
        </div>
      </footer>
    </>
